...
def create_purchase_invoice(billing_data):
    ...
    purchase_invoice = {
        ...
        "cost_center": "HEADOFFICE - MH",
        "items": [
            {
                "item_code": "Purchase Item",
                "qty": 1,
                "rate": total_net_amount - total_tax,
                "amount": total_net_amount - total_tax
            }
        ],
        "total": bill_amount,
    ...
    if total_tax:
        purchase_invoice["taxes"] = [
            {
                "charge_type": "Actual",
                "account_head": "2370 - VAT 5% - MH",  
                "description": "Auto-imported tax",
    ...
    try:
        ...
        # frappe.db.commit()
        doc = frappe.get_doc(purchase_invoice)
